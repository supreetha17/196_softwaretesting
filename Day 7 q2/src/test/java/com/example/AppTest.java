...
public class AppTest {
    ...
    public void test2() throws InterruptedException {
        ...
        WebElement element = driver
                .findElement(By.xpath("//*[@id='common_header']/div[1]/div[3]/nav/div/ul/li[10]/a/span"));
        actions.moveToElement(element).perform();
        ;
        Thread.sleep(3000);
        driver.findElement(
                By.xpath("//*[@id='common_header']/div[1]/div[3]/nav/div/ul/li[10]/div/div/ul/li[2]/ul/li[5]/a"))
                .click();
    ...
    public void test3() throws InterruptedException {
        String invpr = driver
                .findElement(
                        By.xpath("//*[@id='mc_mainWrapper']/div[2]/div/div[3]/div[2]/div[5]/table/tbody/tr[1]/td[2]"))
                .getText();
        String tai = driver
                .findElement(
                        By.xpath("//*[@id='mc_mainWrapper']/div[2]/div/div[3]/div[2]/div[5]/table/tbody/tr[3]/td[2]"))
                .getText();
